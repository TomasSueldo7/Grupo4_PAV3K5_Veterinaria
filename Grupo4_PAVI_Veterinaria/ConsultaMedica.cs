...
namespace Grupo4_PAVI_Veterinaria
{
    public partial class ConsultaMedica : Form
    {
        ...
        private void CargarCombosMedicamentos()
        {
            ...
            cmbMedicamentos.DisplayMember = "Medicacion";
            cmbMedicamentos.ValueMember = "Id_medicamento";
            cmbMedicamentos.SelectedIndex = -1;
        }
        ...
        private void btnAgregarM_Click(object sender, EventArgs e)
        {
            ...
            btnLimpiarMedicamentos.Enabled = true;
        }
        ...
        private void btnAgregarSintomas_Click(object sender, EventArgs e)
        {
            ...
            btnLimpiarSintomas.Enabled = true;
        }
        ...
        private void grdMedicamentos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            btnEliminarMedicamento.Enabled = true;
        }

        private void gdrSintomas_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            btnEliminarSintoma.Enabled = true;
        }

        private void btnEliminarMedicamento_Click(object sender, EventArgs e)
        {

            int index = grdMedicamentos.CurrentRow.Index;
            grdMedicamentos.Rows.RemoveAt(index);

        }

        private void btnEliminarSintoma_Click(object sender, EventArgs e)
        {
            int index = gdrSintomas.CurrentRow.Index;
            gdrSintomas.Rows.RemoveAt(index);
        }
    }
}
