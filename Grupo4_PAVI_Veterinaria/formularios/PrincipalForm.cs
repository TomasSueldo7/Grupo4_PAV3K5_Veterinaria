...
namespace Grupo4_PAVI_Veterinaria.formularios
{
    public partial class PrincipalForm : Form
    {
        ...
        private void consultasPorMesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConsultasPorRaza ventana = new ConsultasPorRaza();
            ventana.ShowDialog();
        }

        private void consultasPorMesToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ConsultasXMes ventana = new ConsultasXMes();
            ventana.ShowDialog();
        }

        private void reporteMedicamentosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConsultaMedicamentos ventana = new ConsultaMedicamentos();
            ventana.ShowDialog();
        }

        private void listadoDeHCToolStripMenuItem_Click(object sender, EventArgs e)
        {
